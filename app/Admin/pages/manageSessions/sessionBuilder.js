...
angular.module('adminWebApp.controllers').controller('SessionBuilderCtrl', ['$scope', '$rootScope', '$routeParams', 'authView',
		...
		function ($scope, $rootScope, $routeParams, authView, $location, tabUtil, resolveData, refreshSession, $window) {
			...
			$window.document.title = "Session Builder | Insider Focus";

			$scope.resolvedData = resolveData;
			$scope.tabs = authView.getSessionBuilderSteps();
